...
/**
 * \brief Performs matrix multiplication using CUDA on two matrices using only
 * VRAM.
...
/**
 * \brief Performs matrix multiplication using CUDA on two matrices using VRAM
 * for the operands pagelocked memory for the result.
 * \param a pointer to a 1D serialized array with size of M*K
 * \param b pointer to a 1D serialized array with size of N*K
 * \param M array's (uncommon) dimension
 * \param N array's (uncommon) dimension
 ...
 * function make the appropiate call depending on the available memory.
 * \param a pointer to a 1D serialized array with size of M*K
 * \param b pointer to a 1D serialized array with size of N*K
 * \param M array's (uncommon) dimension
 * \param N array's (uncommon) dimension
